...
# https://leetcode.cn/problems/cat-and-mouse-ii/?envType=daily-question&envId=2025-02-11
class Solution:
...
if __name__ == '__main__':
    ...
    print(Solution().canMouseWin(grid=["M.C...F"], catJump=1, mouseJump=4))
    print(Solution().canMouseWin(grid=["M.C...F"], catJump=1, mouseJump=3))
    print(Solution().canMouseWin(grid=["C...#", "...#F", "....#", "M...."], catJump=2, mouseJump=5))
    print(Solution().canMouseWin(grid=[".M...", "..#..", "#..#.", "C#.#.", "...#F"], catJump=3, mouseJump=1))
